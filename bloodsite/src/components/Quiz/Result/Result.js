...
function Result(props) {
  ...
  return (
    <div className={classes.result}>
      Correct Answers 
      <div style={{height:"300px",width:"300px"}}><CircularProgressbar 
        styles={buildStyles({
        ...
        background="true" value={correctPer} text={`${correctPer}%`} /></div>;<br/>
      <div style={{height:"300px",width:"300px"}}>Incorrect Answers <CircularProgressbar 
        styles={buildStyles({
          // Rotation of path and trail, in number of turns (0-1)
          rotation: 0.25,
